...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
    ...
    return (
        <>
            ...
            <aside className={`fixed inset-y-0 left-0 z-50 w-72 md:w-64 border-r border-border rounded-r-2xl overflow-hidden bg-card h-screen flex flex-col transition-transform duration-300 md:sticky md:top-0 md:translate-x-0 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
